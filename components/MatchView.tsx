    ...
    return (
      <div className="mb-3">
        <div className="flex justify-between text-xs text-slate-400 mb-1">
          ...
          <span className="uppercase tracking-widest font-bold text-slate-500">{label}</span>
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/90 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-slate-900 w-full max-w-2xl rounded-xl border border-slate-700 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        {/* Header - Scoreboard */}
        <div className="bg-slate-800 p-8 flex justify-between items-center border-b border-slate-700 relative">
            <div className="text-center w-1/3">
                <h3 className="text-xl font-bold text-white truncate">{homeTeam.name}</h3>
                <div className="text-xs text-emerald-400 mt-1">{homeTeam.tactics.structure}</div>
            </div>
            
            <div className="text-center w-1/3 flex flex-col items-center">
                <div className="text-5xl font-black text-white flex gap-4 tracking-tighter">
                ...
                <div className="bg-slate-700 text-slate-300 text-xs px-2 py-0.5 rounded mt-2">
                    FIM DE JOGO
                </div>
            </div>

            <div className="text-center w-1/3">
                <h3 className="text-xl font-bold text-white truncate">{awayTeam.name}</h3>
                <div className="text-xs text-red-400 mt-1">{awayTeam.tactics.structure}</div>
            </div>
        </div>

        {/* Content - Stats & Feedback */}
        <div className="p-6 overflow-y-auto">
            <h4 className="text-center text-slate-500 text-sm font-bold uppercase mb-6 tracking-widest">Estatísticas da Partida</h4>
        ...
        <div className="p-4 bg-slate-800 border-t border-slate-700 text-center">
            <button 
                onClick={onContinue}
                className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 px-12 rounded shadow-lg transition-transform transform hover:scale-105"
            >
                Continuar
            </button>
        </div>
